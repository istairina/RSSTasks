function GarageHTML() {
  ...
  garage.innerHTML = `
<div class="master__line">
  <input class="inp" type="text" />
  <input class="color" type="color" />
  <button class="btn second">create</button>
</div>
<div class="master__line">
  <input class="inp" type="text" />
  <input class="color" type="color" />
...
<div>
  <button class="btn second">generate cars</button>
</div>
<div>
...
<main>
<h1 class="main__title">Garage (104)</h1>
<p class="main__page">Page #1</p>
<div class="car__box">
  <div class="car__header">
    <button class="btn second">select</button>
    <button class="btn second">remove</button>
    <span class="car__brand">Tesla</span>
  </div>
  <div class="car__rule-button">
    <div class="car__start-stop start">A</div>
    <div class="car__start-stop">B</div>
  </div>
  <div class="car__images">
    <div class="car__road"><hr /></div>
